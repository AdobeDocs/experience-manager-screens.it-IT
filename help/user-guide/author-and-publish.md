...
>[!NOTE]
>
>Per ulteriori informazioni sulla panoramica dell&#39;architettura di authoring e pubblicazione e su come il contenuto viene creato in un&#39;istanza di AEM Author e poi replicato in avanti in più istanze di pubblicazione, consulta [Panoramica dell&#39;architettura di authoring e pubblicazione](author-publish-architecture-overview.md).
...
1. Passa alla tua istanza di AEM > icona a forma di martello > **Operazioni** > **Configurazione**.
...
1. **Connettore topologia `Whitelist` elenco**: adattarsi a IP o subnet che coprono tutte le istanze di pubblicazione. Assicurarsi di `whitelist` il nome IP/host di tutte le istanze Publish senza il numero di porta.
...
1. Fare clic sul dispositivo e fare clic su **Attiva** nella barra delle azioni, come illustrato nella figura seguente.
...
1. Esegui **Gestisci pubblicazione** per pubblicare le nuove modifiche in tutte le istanze di pubblicazione.
1. Fare clic su **Attiva** per abilitare il dispositivo da **Gestione dispositivi**.
...
1. Cambia l&#39;istanza Autore in istanza Pubblica in **Server**.
